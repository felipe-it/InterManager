...
public class ClientePanel extends javax.swing.JPanel {
    ...
    initComponents();
    cargarClientes("");
    tablaClientesSetStyle();
    ordenarTabla();
    }
    
    private void tablaClientesSetStyle(){
    ...
    List<Cliente> lista = controller.listarPorUsuario(SesionUsuario.getUsuario().getId());
    lista.stream()
    ...
    TableRowSorter<TableModel> sorter = new TableRowSorter<>(tableClientes.getModel());
    ...
    private void initComponents() {
        ...
        tableClientes.setFont(new java.awt.Font("Segoe UI", 0, 11)); // NOI18N
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        cargarClientes(txtfieldBuscador.getText().trim());
    }//GEN-LAST:event_btnBuscarActionPerformed

    private void btnNuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNuevoActionPerformed
        
        String nombre = JOptionPane.showInputDialog(this, "Nombre del cliente:");
        String email = JOptionPane.showInputDialog(this, "Email del cliente:");
    ...
    String nombreActual = (String) tableClientes.getValueAt(fila, 1);
    String emailActual = (String) tableClientes.getValueAt(fila, 2);
    String telefonoActual = (String) tableClientes.getValueAt(fila, 3);
    ...
    private void tableClientesMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableClientesMouseEntered
    ...
    }//GEN-LAST:event_tableClientesMouseEntered
    ...
    if (userSelection == JFileChooser.APPROVE_OPTION) {
        ...
        ExportarCSV.exportarTablaCSV(tableClientes, archivo);
    }
